            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-md-6 mx-auto mt-1 pt-1 px-5 pb-1 rounded text-center'>
                        ...
                        <div className='btn-toolbar d-block justify-content-center p-2 mt-2'>
                            <div className='btn-group mr-2 mb-2'>
                                <button type='button' className='btn btn-success' onClick={this.onFormSubmit}>Save</button>
                            </div>
                            <div className='btn-group mr-2 mb-2'>
                                <button type='button' className='btn btn-outline-danger' onClick={this.cancelProfileUpdate} >Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
